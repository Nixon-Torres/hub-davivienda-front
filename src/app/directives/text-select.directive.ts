/*
*IMPORTANT*: This code is based on
* https://www.bennadel.com/blog/3439-creating-a-medium-inspired-text-selection-directive-in-angular-5-2-10.htm
*/
import { Directive, ElementRef, EventEmitter, Output, NgZone, OnDestroy, OnInit } from '@angular/core';
...
export class TextSelectDirective implements OnInit, OnDestroy {
    ...
    @Output()
    public clickEvent: EventEmitter<CustomClickEvent>;
    ...
    private handleMouseClick = (evt): void => {
        this.clickEvent.emit({target: evt.target});
    };
